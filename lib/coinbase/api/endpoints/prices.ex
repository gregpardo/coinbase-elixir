defmodule Coinbase.API.Prices do
  ...
  @search_key :totals # Note we use totals here because that's probabably what people would most care about
  ...
  def get_buy(coinbase, optionals \\ %{}) do
    ...
    Base.get(coinbase, "#{@endpoint}/buy", params, @data_struct, @search_key)
  end
  ...
  def get_sell(coinbase, optionals \\ %{}) do
    params = add_optionals(%{}, optionals)
    Base.get(coinbase, "#{@endpoint}/sell", params, @data_struct, @search_key)
  end
  ...
  def get_spot(coinbase, optionals \\ %{}) do
    params = add_optionals(%{}, optionals)
    Base.get(coinbase, "#{@endpoint}/spot_rate", params, @data_struct, @search_key)
  end
...
#  @doc """
  ...
  #def get_historical(coinbase, optionals \\ %{}) do
    #false
    ##params = add_optionals(%{}, optionals)
    ##Base.get(coinbase, "#{@endpoint}/historical", params, @data_struct, @search_key)
#  end
end
